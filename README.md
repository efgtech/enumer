## Important
We have forked this repo in an effort to keep this incredible tool going. We will actively contribute where required and accept PRs as it doesn't look like the original repo is maintained anymore.
...
```
go get github.com/efgtech/enumer
```
